...
values ('Степан', 'Степанович', 'm', 30);
insert into employee (first_name, last_name, gender, age)
values ('John', 'White', 'm', 24);
insert into employee (first_name, last_name, age)
values ('Mark', 'Hunter', 45);
...
--## 1 Задание
insert into employee (first_name, last_name, gender, age)
values ('Мария', 'Долматова', 'w', 45);
insert into employee (first_name, last_name, age)
values ('Antony', 'Smith', 45);
...
from employee
where age = (select min(age) as минимальный_возраст
             from employee);
